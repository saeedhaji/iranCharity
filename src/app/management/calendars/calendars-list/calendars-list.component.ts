...
import { CalendarsAddComponent } from "../calendars-add/calendars-add.component";
...
export class CalendarsListComponent implements OnInit {
  ...
  openDialog() {
    const dialogRef = this.dialog.open(CalendarsAddComponent,{
      // height: '400px',
      // width: '600px', 
    });
  ...
  openDialogOne() {
    const dialogRef = this.dialog.open(CalendarsDetailComponent,{
      // height: '400px',
       width: '600px', 
    });
